...
Begin VB.Form frmGOTVPaymentHistory 
   Caption         =   "GOTV PAYMENT RECORD"
   ClientHeight    =   8430
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14760
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "GOTV Payment History.frx":0000
         Height          =   7095
         Left            =   120
         TabIndex        =   3
         Top             =   480
   ...
   End
End
Attribute VB_Name = "frmGOTVPaymentHistory"
