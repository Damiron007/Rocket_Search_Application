...
Begin VB.Form frmStartimesPaymentHistory 
   Caption         =   "STARTIMES PAYMENT RECORD"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Startimes Payment History"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   14.25
         Charset         =   0
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "Startimes Payment History.frx":0000
         Height          =   7095
         Left            =   120
         TabIndex        =   3
         Top             =   480
   ...
   End
End
Attribute VB_Name = "frmStartimesPaymentHistory"
